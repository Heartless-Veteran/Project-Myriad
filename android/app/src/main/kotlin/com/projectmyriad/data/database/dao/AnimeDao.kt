...
import com.projectmyriad.domain.entities.AnimeStatus
...
interface AnimeDao {
    ...
    suspend fun updateWatchProgress(animeId: String, watchedEpisodes: Int, lastWatchedDate: java.util.Date)
    ...
    suspend fun updateLibraryStatus(animeId: String, isInLibrary: Boolean)
