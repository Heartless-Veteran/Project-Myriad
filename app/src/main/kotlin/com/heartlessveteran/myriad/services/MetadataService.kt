...
class MetadataService @Inject constructor(
     ...
     */
    suspend fun getMetadata(contentId: String, contentType: String): Result<ContentMetadata> {
     ...
     */
    suspend fun updateUserMetadata(contentId: String, userMetadata: UserMetadata): Result<Unit> {
        return withContext(Dispatchers.IO) {
            try {
     ...
     */
    private suspend fun scrapeMetadataFromSources(contentId: String, contentType: String): ContentMetadata {
