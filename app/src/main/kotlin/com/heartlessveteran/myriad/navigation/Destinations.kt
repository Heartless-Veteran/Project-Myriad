...
object NavigationRoutes {
    ...
    const val READING = "reading/{mangaId}/{chapterId}?page={page}"
    const val READING_NO_CHAPTER = "reading/{mangaId}?page={page}"
    const val WATCHING = "watching/{animeId}/{episodeId}?timestamp={timestamp}"
    const val WATCHING_NO_EPISODE = "watching/{animeId}?timestamp={timestamp}"
