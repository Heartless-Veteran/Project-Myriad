...
interface MangaDao {
    ...
    suspend fun updateReadProgress(mangaId: String, readChapters: Int, lastReadDate: java.util.Date)
    ...
    suspend fun updateLibraryStatus(mangaId: String, isInLibrary: Boolean)
