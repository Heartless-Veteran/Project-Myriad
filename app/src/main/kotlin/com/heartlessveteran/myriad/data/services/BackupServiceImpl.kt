...
class BackupServiceImpl(
    ...
    override fun restoreFromFile(
        ...
        try {
            ...
            val result = RestoreResult(
                success = true,
                itemsRestored = RestoreItemCounts(
                    mangaRestored = 10,
                    animeRestored = 5,
    ...
    override fun getBackupConfiguration(): BackupConfiguration {
        return BackupConfiguration(
            ...
            autoBackupFrequency = AutoBackupFrequency.valueOf(
    ...
    override suspend fun createAutomaticBackup(): Result<AutoBackupResult> {
        return try {
            ...
            val shouldBackup = when (config.autoBackupFrequency) {
    ...
    private fun writeBackupToFile(file: File, backupData: BackupData) {
