...
class MemoryCacheTest {
    ...
    @Test
    fun `should create and retrieve cache`() = runTest {
    ...
    @Test
    fun `should return same cache instance for same key`() = runTest {
    ...
    @Test
    fun `should clear all caches`() = runTest {
        val cache = memoryCache.getCache<String>("test_cache")
...
class CacheTest {
    ...
    @Test
    fun `should store and retrieve values`() = runTest {
        cache.put("key1", "value1")
    ...
    @Test
    fun `should evict oldest entries when cache is full`() = runTest {
        cache.put("key1", "value1")
    ...
    @Test
    fun `should remove specific key`() = runTest {
        cache.put("key1", "value1")
        cache.put("key2", "value2")
    ...
    @Test
    fun `should track cache metrics`() = runTest {
    ...
    @Test
    fun `should track evictions in metrics`() = runTest {
    ...
    @Test
    fun `should return all keys`() = runTest {
        cache.put("key1", "value1")
        cache.put("key2", "value2")
